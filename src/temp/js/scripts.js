...
var _scrollAnimations = __webpack_require__(32);

var _scrollAnimations2 = _interopRequireDefault(_scrollAnimations);

var _formValid = __webpack_require__(31);

var _formValid2 = _interopRequireDefault(_formValid);
...
var scrollAnimations = new _scrollAnimations2.default();
var formValid = new _formValid2.default();
...
var _formSerialize = __webpack_require__(11);
...
var FormValid = function () {
	function FormValid() {
		_classCallCheck(this, FormValid);
	...
	_createClass(FormValid, [{
		...
		value: function sendForm() {
			...
			var formData = (0, _formSerialize2.default)(this.contactForm);
			var request = _axios2.default.post(url, formData);
			var formMessage = "";

			request.then(function () {
				formMessage = "Wiadomość została wysłana poprawnie.";
				_this.formMessage.classList.remove("form-message--error");
				_this.formMessage.classList.add("form-message--success");
				[].concat(_toConsumableArray(_this.formFields)).map(function (field) {
					field.value = "";
				});
			}).catch(function () {
				formMessage = "Wystąpił błąd podczas wysyłania formularza. Proszę spróbować ponownie.";
				_this.formMessage.classList.add("form-message--error");
				_this.formMessage.innerText = formMessage;
			});
		}
	}, {
		key: "checkForm",
		value: function checkForm(e) {
			...
			var hasErrors = false;
			var formMessage = "";
			var email = this.contactForm.email.value.trim();
			var message = this.contactForm.message.value.trim();
...
var _noframework = __webpack_require__(101);
...
var ScrollAnimations = function () {
	...
	_createClass(ScrollAnimations, [{
		...
		value: function setItems() {
			[].concat(_toConsumableArray(this.animateItems)).map(function (item) {
...
exports.default = ScrollAnimations;
...
var SiteNav = function () {
	...
	_createClass(SiteNav, [{
		...
		value: function toggleMenu() {
			var hasClass = this.siteNav.classList.contains("site-nav--is-expanded");
		...
		value: function activeLinks() {
			var that = this;
			[].concat(_toConsumableArray(this.siteSections)).map(function (section) {
				new Waypoint({
					element: section,
					handler: function handler(direction) {
						if (direction === "down") {
							var linkId = section.dataset.link;
							var matchingLink = document.querySelector(linkId);
							[].concat(_toConsumableArray(that.siteLinks)).map(function (item) {
...
var Slider = function () {
	function Slider() {
		...
		this.sliderItems = (0, _jquery2.default)(".portfolio-slider");
		this.viewportWidth = window.innerWidth;
		this.prevArrow = (0, _jquery2.default)(".pagination__prev");
		this.nextArrow = (0, _jquery2.default)(".pagination__next");
		this.startSlider();
	}
	...
	_createClass(Slider, [{
		...
		value: function startSlider() {
			...
			if (this.viewportWidth > MQ) this.sliderItems.slick(config);
		}
	}]);
